...
(async function(){
  ...
  async function renderAll(){
    ...
    $('df_counts').textContent = `${dfPaid.length} paid Â· ${(MATATUS.length - dfSet.size)} due`;
    ...
    $('ln_counts').textContent = `${lnPaid.length} collected today Â· ${dueCount} due today (${allLoans.length} loans)`;
